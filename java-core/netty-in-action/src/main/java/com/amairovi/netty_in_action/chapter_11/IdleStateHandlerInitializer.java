...
public class IdleStateHandlerInitializer extends ChannelInitializer<Channel> {
    ...
    public static final class HeartbeatHandler extends SimpleUserEventChannelHandler<IdleStateEvent> {
        ...
        @Override
        protected void eventReceived(final ChannelHandlerContext ctx, final IdleStateEvent evt) throws Exception {
